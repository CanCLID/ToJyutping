...
def download_file_if_not_exist():
	if not path.exists('jyut6ping3.dict.yaml'):
		urllib.request.urlretrieve('https://raw.githubusercontent.com/rime/rime-cantonese/master/jyut6ping3.dict.yaml', 'jyut6ping3.dict.yaml')
...
def main():
	...
	d = build_dict()
	t = build_trie(d)
	s = '我心匪石不可轉，澳大利亞，新西蘭和我沙面率領概率'
	s = replace_words_plain(s, t)
	print(s)
